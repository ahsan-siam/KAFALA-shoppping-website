...
VALUES ('$id','','$name','$num','$add','$total','','','$time','','GATEWAY');";
...
$post_data = array();
$post_data['store_id'] = "kafal6396168608577";
$post_data['store_passwd'] = "kafal6396168608577@ssl";
...
$post_data['ship_name'] = "testkafaldjzq";
